           ...
           <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                 <?php                  
                $query = 'SELECT a.Product_Id,a.Product_Name,a.Product_image,b.supname,b.Supplier_id,c.categoryname,sum(a.Quantity)as quantity,sum(a.Onhand) as onhand,a.Original_price
