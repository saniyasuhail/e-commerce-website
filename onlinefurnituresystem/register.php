      ...
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          ...
          if (isset($_GET['error'])) {
           ...
           if ($_GET["error"]=="invalidmail") {
            ...
            elseif ($_GET["error"]=="usertaken") {
               echo '<div><p class="signuperror">Username is already taken</p><div>';
            }
            } 
          ...
          <form action="includes/signup.php" method="post">
            ...
            <div class="form-group">
              <div class="form-label-group">
                <input type="number" id="inputContact" name="contact" class="form-control" placeholder="Contact" minlength="10" maxlength="10" required>
