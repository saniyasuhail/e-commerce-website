...
function getCallbackUrl()
{
	...
	return $protocol . $_SERVER['HTTP_HOST'] . '/onlinefurnituresystem/orderview.php';
}
...
<div class="main">
    ...
    <span><input type="text" id="key" name="key" placeholder="Merchant Key" value="iJGJIqLn" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Merchant Salt:</label></span>
    <span><input type="text" id="salt" name="salt" placeholder="Merchant Salt" value="8H3D0qRhBa" /></span>
    </div>
