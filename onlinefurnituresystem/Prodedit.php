                  ...
                  <h2>Edit Records</h2>
                        ...
                        <div class="col-lg-6">
                            ...
                            <label for="Product_Name">Product Name</label>
                              <input class="form-control" placeholder="Product Name" name="Product_Name" value="<?php echo $i1; ?>">
                            </div>
                            <div class="form-group">
                            <label for="Supplier Id">Supplier Id</label>
                              <input class="form-control" placeholder="Supplier Id" name="Supplier_id" value="<?php echo $a; ?>">
                            </div> 
                            <div class="form-group">
