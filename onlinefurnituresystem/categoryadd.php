          ...
          <center>
                  <h2>Add new Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="categorytrans.php?action=add"  enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="category name" name="categoryname">
                                    ...
                                    <input class="input-file2" type="file" name="categoryimage" id=categoryimage" required>
